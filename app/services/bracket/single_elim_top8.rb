...
module Bracket
  class SingleElimTop8 < Base
    ...
    game 2, seed(2), seed(7), round: 1
    game 3, seed(3), seed(6), round: 1
    game 4, seed(4), seed(5), round: 1

    game 5, seed_of([winner(1), winner(2), winner(3), winner(4)], 1),
         seed_of([winner(1), winner(2), winner(3), winner(4)], 4), round: 2
    game 6, seed_of([winner(1), winner(2), winner(3), winner(4)], 2),
         seed_of([winner(1), winner(2), winner(3), winner(4)], 3), round: 2

    game 7, seed_of([winner(5), winner(6)], 1), seed_of([winner(5), winner(6)], 2), round: 3
